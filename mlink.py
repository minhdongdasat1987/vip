...
# Ví dụ minh hoạ xuất kết quả có dòng phân cách

def display_result(wifi_name, password):
    print(f"WiFi: {wifi_name}")
    print(f"Password: {password}")
    print("[94m" + "=" * 50 + "[0m")  # Dòng kẻ xanh dương
...
if __name__ == "__main__":
    ...
    for wifi, pwd in results:
        display_result(wifi, pwd)
